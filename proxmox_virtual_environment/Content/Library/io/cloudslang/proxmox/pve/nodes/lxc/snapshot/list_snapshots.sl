########################################################################################################################
#!!
#! @description: Get a list of all snapshots for a given LXC on a selected PVE node
#!
...
#! @input node: The PVE node where the LXC is running on. Example: pve-node3
#! @input vmid: The vmid of the LXC to check for snapshots
#!!#
########################################################################################################################
