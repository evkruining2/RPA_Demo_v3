...
#! @input node: Name of the PVE node that is hosting the LXC to snapshot. Example: pve-node2
#! @input vmid: The vmid of the LXC that needs a snapshot
#! @input snapname: The name of the new snapshot (string)
#!!#
########################################################################################################################
    ...
    - create_snapshot:
        do:
          io.cloudslang.base.http.http_client_post:
            - url: "${pveURL+'/api2/json/nodes/'+node+'/lxc/'+vmid+'/snapshot'}"
            - auth_type: basic
