...
#! @input poolID: The name of the pool to create. Example: prod_pool
#! @input description: The description of the pool
#!
#! @output JobStatus: Status of the pool creation job
#!!#
########################################################################################################################
    ...
    - create_pool:
        do:
          io.cloudslang.base.http.http_client_post:
            ...
            - body: "${'poolid='+poolID+'&comment='+description}"
  ...
  graph:
    steps:
      ...
      get_status_id:
        ...
        'y': 136
        navigate:
          0f9cca5b-bb77-7b51-6eb8-330695c18bc9:
