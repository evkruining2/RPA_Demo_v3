...
operation:
  name: 05_Run_Report_Phase_5
  inputs:
    - Duration
  sequential_action:
    gav: 'com.microfocus.seq:RPA_Demo.Sub_flows.05_Run_Report_Phase_5:1.0.0'
    skills:
      - Java
      - SAP
      - SAP NWBC Desktop
    ...
    steps:
      ...
      - step:
          ...
          highlight_id: '1967590'
          args: '"Successfully verified the new item in the AOS store!"'
      - step:
          id: '15'
          object_path: 'Window("Notepad").WinEditor("Edit")'
          action: Type
      ...
      - step:
          ...
          highlight_id: '1967590'
          args: '"Total duration of this operation (in seconds) was: "'
      - step:
          id: '23'
          object_path: 'Window("Notepad").WinEditor("Edit")'
          action: Type
